...
const QuickNIPRInfo: FC<QuickNIPRInfoProps> = () => {
  return (
    <div className="w-frame">
      <div className="grid grid-cols-[2fr_1fr] gap-[4rem] lg:gap-12 ">
        <div className="space-y-12 ">
          <h3 className="text-[#ED3237] text-[2.8rem] font-semibold">
            Championing Excellence in Nigerian Communications
          </h3>
          <p className="text-2xl leading-[3.4rem]  text-[#676767]">
        ...
        <div className="max-w-[46rem] max-h-[40rem] relative">
          ...
          <div className="absolute bottom-4 right-4 left-4 text-white text-2xl ">
